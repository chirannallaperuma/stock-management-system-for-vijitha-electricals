...
Route::group(['middleware' => ['auth'], 'prefix' => 'grn', 'as' => 'grn'], function () {
    Route::get('/index', ['as' => 'index', 'uses' => 'GrnController@index', 'middleware' => 'roles', 'roles' => ['admin', 'manager', 'user']]);
...
Route::group(['middleware' => ['auth'], 'prefix' => 'gtn', 'as' => 'gtn'], function () {
    Route::get('/index', ['as' => 'index', 'uses' => 'GtnController@index', 'middleware' => 'roles', 'roles' => ['admin', 'manager', 'user']]);
...
Route::group(['middleware' => ['auth'], 'prefix' => 'invoice', 'as' => 'invoice'], function () {
    Route::get('/index', ['as' => 'index', 'uses' => 'InvoiceController@index', 'middleware' => 'roles', 'roles' => ['admin', 'manager', 'user']]);
